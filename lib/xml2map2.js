/* ================================================================
 * xml2map2 by xdf(xudafeng[at]126.com)
 *
 * first created at : Mon Jun 16 2014 14:49:10 GMT+0800 (CST)
 *
 * ================================================================
 * Copyright 2014 xdf
 *
 * xml2map2 is based on node-xml-mapping
 *
 * repository: https://github.com/xudafeng/xml2map2
 * contribute by Joe Ibershoff, Yura Zenevich, Thorsten, Lorenz, ntgn81, Rowell Cruz, and JT
 *
...
exports.toxml = function(obj, options) {
  options = options || {};
...
exports.tojson = function(str, options) {
  options = options || {};
